...
stateSetter = (event) => {
  ...
  if (event.target.value.length !== 0) {
    ...
    menuVisibility: 'none',    
      startStation1: backToJson.startStation1,
      startStation2: backToJson.startStation2,
      startStation3: backToJson.startStation3,
      destinationStation1: backToJson.destinationStation1, 
      destinationStation2: backToJson.destinationStation2, 
      destinationStation3: backToJson.destinationStation3, 
      amPm: backToJson.amPm, // FORMAT 'a.m.' or 'p.m.'
      ticketIdNo: backToJson.ticketIdNo, // TTDQWE4CFWM
  ...
  render () {
    ...
    return (
      ...
      ticking={true} />{this.state.amPm}</span>
          ...
          <div class="id-number">
          <p style={{position: 'relative', left: '24px', bottom: '20px', color: 'white', fontFamily: 'Khula, sans-serif', fontWeight: '999', fontSize: '20px'}}>{this.state.ticketIdNo}</p>
    ...
    overflowX: 'hidden', overflowY: 'scroll'}}>
          ...
          <div class="dropdown-content" style={{display: this.state.menuVisibility}}>
             ...
             <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#EEBCBA'}} onBlur={this.color1.bind(this)} placeholder="color1"/>
        </div>
        <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#EEBCBA'}} onBlur={this.color2.bind(this)} placeholder="color2"/>
        </div>
        <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#EEBCBA'}} onBlur={this.color3.bind(this)} placeholder="color3"/>
        </div>


          <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#EEBCBA'}} onBlur={this.startStation1.bind(this)} placeholder="startStation1"/>
        </div>
        <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#EEBCBA'}} onBlur={this.startStation2.bind(this)} placeholder="startStation2 (leave blank)"/>
        </div>
        <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#EEBCBA'}} onBlur={this.startStation3.bind(this)} placeholder="startStation3 (leave blank)"/>
        </div>
        <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#EEBCBA'}} onBlur={this.destinationStation1.bind(this)} placeholder="destinationStation1"/>
        </div>
        <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#EEBCBA'}} onBlur={this.destinationStation2.bind(this)} placeholder="destinationStation2 (leave blank)"/>
        </div>
        <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#EEBCBA'}} onBlur={this.destinationStation3.bind(this)} placeholder="destinationStation3 (leave blank)"/>
        </div>
       
        <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#EEBCBA'}} onBlur={this.ticketIdNo.bind(this)} placeholder="ticketIdNo (eg. 'TTDQWE4CFWM')"/>
        </div>
        <div>
        ...
        {/* <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#EEBCBA'}} onBlur={this.timePurchased.bind(this)} placeholder="timePurchased (eg. '17:25')"/>
        </div>
        <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#EEBCBA'}} onBlur={this.activatedTime.bind(this)} placeholder="activatedTime (eg. '18:01')"/>
        </div> */}
        
        <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#EEBCBA'}} onBlur={this.ticketPrice.bind(this)} placeholder="ticketPrice no £ sign (eg. '69.00')"/>
        </div>
        <div>
...
<div><button type="button" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#D3D3D3'}}onClick={this.saveTicket}>SAVE TICKET</button></div>



        <div>
          <input type="text" style={{width: '300px', height: '50px', fontSize: '20px', backgroundColor: '#a4c5e8'}} onBlur={this.stateSetter.bind(this)} placeholder="paste saved ticket code here"/>
        </div>
        {/* 
         <div>
          <input type="text" style={{width: '300px'}} onBlur={this.amPm.bind(this)} placeholder="amPm (eg. 'a.m.' or 'p.m.')"/>
        </div>
        <div>
          <input type="text" style={{width: '300px'}} onBlur={this.dayShortFormat.bind(this)} placeholder="dayShortFormat (eg. 'Mon', 'Tue', 'Wed', Thu', 'Fri', 'Sat', 'Sun')"/>
        </div>
        <div>
          <input type="text" style={{width: '300px'}} onBlur={this.dayDate.bind(this)} placeholder="dayDate (eg. '19')"/>
        </div>
        <div>
          <input type="text" style={{width: '300px'}} onBlur={this.monthShortFormat.bind(this)} placeholder="monthShortFormat (eg. 'Jan')"/>
        </div> */}
